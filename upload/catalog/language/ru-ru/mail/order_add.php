...
$_['text_greeting']         = 'Благодарим Вас за интерес к %s товарам. Ваш заказ был получен и будет обработан после подтверждения оплаты.';
...
$_['text_total']            = 'Всего';
$_['text_download']         = 'Как только Ваш платеж будет подтвержден, Вы можете нажать на ссылку ниже, чтобы получить доступ к загружаемым продуктам:';
